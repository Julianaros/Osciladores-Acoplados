...
ax2.plot(t, euler[0], label='x1 (Euler)', linestyle='-', color='green')
ax2.plot(t, euler[1], label='x2 (Euler)', linestyle='-', color='orange')
ax2.set_xlabel("Tiempo (s)")
ax2.set_ylabel("Posición (m)")
ax2.set_title("Oscilador Acoplado - Método de Euler")
ax2.legend()

ax3.plot(t, rk4[0], label='x1 (RK4)', linestyle='-', color='purple')
ax3.plot(t, rk4[1], label='x2 (RK4)', linestyle='-', color='green')
