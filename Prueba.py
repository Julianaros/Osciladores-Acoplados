...
resultados_euler, resultados_rk4 = ejecutar_metodos(tf)

# Ejemplo de impresión de los primeros 5 resultados
for i in range(5):
    print(f"t = {t0 + i * dt:.2f}, Euler: x1 = {resultados_euler[0][i]:.4f}, x2 = {resultados_euler[1][i]:.4f}")
    print(f"t = {t0 + i * dt:.2f}, RK4: x1 = {resultados_rk4[0][i]:.4f}, x2 = {resultados_rk4[1][i]:.4f}")
